...
minetest.register_node("atm:atm", {
	description = "ATM",
	paramtype2 = "facedir",
	groups = {snappy=1,choppy=2,oddly_breakable_by_hand=2,flammable=3,bank_equipment = 1},
	drawtype = "mesh",
	mesh = "atm.b3d",
    tiles = {"caixa04.png"},
	light_source = 12,
...
minetest.register_node("atm:atm2", {
	...
	paramtype2 = "facedir",
	groups = {snappy=1,choppy=2,oddly_breakable_by_hand=2,flammable=3,bank_equipment = 2},
	--legacy_facedir_simple = true,
	is_ground_content = false,
	sounds = default.node_sound_stone_defaults(),
	drawtype = "mesh",
...
minetest.register_node("atm:atm3", {
	...
	paramtype2 = "facedir",
	groups = {snappy=1,choppy=2,oddly_breakable_by_hand=2,flammable=3,bank_equipment = 3},
	--legacy_facedir_simple = true,
	is_ground_content = false,
	sounds = default.node_sound_stone_defaults(),
	drawtype = "mesh",
