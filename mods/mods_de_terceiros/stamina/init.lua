...
STAMINA_TICK_MIN = 800		-- stamina ticks won't reduce stamina below this level
...
STAMINA_EXHAUST_PUNCH = 90	-- .. if player punches another player
...
STAMINA_VISUAL_MAX = 40		-- hud bar extends only to 20
